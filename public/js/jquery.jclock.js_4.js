...
* 
* Edited By Daniel Mestas February 2011 <dan5446@gmail.com>
*/
(function($) {
  ...
  $.fn.jclock.defaults = {
    format: '<div id="time" class="steelGradient"><h2>%I:%M %p</h2></div> <div id="date"><h3>%A, %B %d</h3></div>',
    utcOffset: 0,
    utc: false,
    fontFamily: '',
    fontSize: '',
    ...
    background: '',
    seedTime: undefined,
    timeout: 60000 // 1000 = one second, 60000 = one minute
  };
